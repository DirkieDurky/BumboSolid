...
namespace BumboSolid.Data
{
    public static class UserAndRoleSeeder
    {
        ...
        private static void SeedUsers(UserManager<User> userManager)
        {
            ...
            if (userManager.FindByEmailAsync("bobby@bumbo.com").Result == null)
            {
                User employee = new User
                {
                    Email = "bobby@bumbo.com",
                    FirstName = "Bobby",
                    LastName = "Bouwman",
                    PlaceOfResidence = "",
                    StreetName = "",
                    StreetNumber = 2,
                    BirthDate = new DateOnly(2000, 6, 18),
                    EmployedSince = new DateOnly(2023, 7, 12),
                    UserName = "bobby@bumbo.com",
                    AvailabilityRules = new List<AvailabilityRule>()
                    {
                        new AvailabilityRule()
                        {
